    ...
    return (
        ...
        <div className="modal modal-bottom sm:modal-middle">
            <div className="modal-box">
                ...
                <textarea onBlur={handleCommentBlur} className="form-control textarea textarea-info w-full rounded-2xl max-w-xs my-2" cols="25" rows="2" placeholder="Give the feedback here" name='description' required></textarea>

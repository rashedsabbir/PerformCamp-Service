...
const Goal = () => {
  ...
  <div class="flex flex-col lg:flex-row py-5">
    <div class=" text-center px-6">
      <div class="bg-blue-500 rounded-lg flex items-center justify-center border border-gray-200">
        ...
        <div class="w-2/3 bg-blue-300 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step">
          <h2 class="font-bold text-sm">Complete Tasks</h2>
    ...
    <div class=" invisible lg:visible flex justify-center items-center">
    ...
    <div class=" text-center px-6">
      <div class="bg-green-500 rounded-lg flex items-center justify-center border border-gray-200">
        <div class="w-1/3 bg-transparent h-20 flex items-center justify-center icon-step">
        ...
        <div class="w-2/3 bg-green-300 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step">
          <h2 class="font-bold text-sm">Update Reviews</h2>
          <p class="text-xs text-gray-600  ">
    ...
    <div class=" text-center px-6">
      <div class="bg-red-500 rounded-lg flex items-center justify-center border border-gray-200">
        <div class="w-1/3 bg-transparent h-20 flex items-center justify-center icon-step">
          <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M21 6.285l-11.16 12.733-6.84-6.018 1.319-1.49 5.341 4.686 9.865-11.196 1.475 1.285z"/></svg>
        </div>
        <div class="w-2/3 bg-red-300 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step">
          <h2 class="font-bold text-sm">Resolve Backlog</h2>
          <p class="text-xs text-gray-600">
  ...
  <div class="grid grid-cols-1 gap-20 lg:grid-cols-2  lg:gap-10">
    ...
    <div class="flex items-center flex-wrap max-w-md px-10 bg-white shadow-xl rounded-2xl h-20"
       ...
       >
          ...
          <p class="ml-10 font-medium text-blue-600 text-center sm:text-xl">In Progress</p>
